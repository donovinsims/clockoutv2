...
export default function LocationRoscoe() {
  return (
    <main>
      {/* Hero */}
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 pt-20 md:pt-32 pb-20 md:pb-28">
          <h1>Automation installs for Roscoe businesses.</h1>
          <p className="mt-7 text-muted-foreground max-w-2xl text-[clamp(1.0625rem,1.6vw,1.25rem)]">
            ...
            Fixed price. Done in days. Based in Roscoe.
          </p>
          <div className="mt-10">
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-6">
          <p className="mono text-[13px] text-muted-foreground">
            Serving Roscoe · Rockford · Machesney Park · Loves Park · Belvidere · Rockton · South Beloit · Cherry Valley · Beloit area
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-20 md:py-28">
          ...
          <h2 className="max-w-3xl">What I build for Roscoe businesses.</h2>
